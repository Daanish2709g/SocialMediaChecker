...
public class GetLinkedInAccessToken {
    public static void main(String[] args) {
        try {
            GetLinkedInAccessToken task = new GetLinkedInAccessToken(new URL("https://www.linkedin.com/oauth/v2/accessToken"));
    ...
    public GetLinkedInAccessToken(URL target) {
        url = target;
        params = new HashMap<>();
    }
